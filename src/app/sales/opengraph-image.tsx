  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <svg width="100" height="100" viewBox="0 0 24 24" fill="#ef4444">
          ...
          <svg width="100" height="100" viewBox="0 0 24 24" fill="#22c55e">
        ...
        >
          Australian vehicle sales figures behind the eLitre calculation
        </div>
